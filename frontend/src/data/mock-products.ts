...
> = [
  ...
  },
  {
    ...
    description: "Deep black denim with TygaMart red embroidery on coin pocket. Five-pocket slim fit.",
    retail_price: 60,
  ...
  },
  {
    ...
    description: "Slim cargo pants with TygaMart branded inner waistband and custom button detail.",
    retail_price: 50,
    compare_at_price: null,
    category_id: "cat-3",
  ...
  },
  {
    ...
    description: "Navy slim-fit chinos with TygaMart embroidered waistband. Stretch cotton twill.",
    retail_price: 50,
    compare_at_price: null,
    category_id: "cat-3",
    image_url: img.navyChinoPants,
  ...
  },
  {
    ...
    description: "White dress shirt with TygaMart crown logo on inner collar. Contrast trim detail.",
    retail_price: 45,
    compare_at_price: null,
    category_id: "cat-4",
  ...
  },
  {
    ...
    description: "Classic bomber with orange lining, ribbed cuffs, and TygaMart sleeve embroidery.",
    retail_price: 90,
  ...
  },
  {
    ...
    description: "Crisp white dress shirt with contrast inner collar and TygaMart crown chest logo.",
    retail_price: 45,
    compare_at_price: 55,
    category_id: "cat-4",
  ...
  {
    id: "p-20",
    name: "TygaMart Cotton Tee — Neck Detail",
    slug: "tygastyle-cotton-tee-neck-detail",
    description: "Premium white cotton tee with red TygaMart neck tape and woven tiger crown label.",
    retail_price: 25,
    compare_at_price: 32,
    category_id: "cat-1",
  ...
  {
    id: "p-21",
    name: "TygaMart Signature Tee Set",
    slug: "tygastyle-signature-tee-set",
    description: "Black and navy TygaMart tees with chest logo. Raglan sleeve navy option. Tag detail included.",
    retail_price: 30,
